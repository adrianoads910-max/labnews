     ...
     return (
       <main className="min-h-screen flex flex-col bg-brand-blue-light">
         ...
         <section className="flex flex-col lg:flex-row items-center justify-center flex-1 px-6 py-10">
           ...
           <form onSubmit={handleSubmit}  className="flex flex-col items-center justify-center text-center p-10 lg:p-16 gap-8 bg-brand-blue-dark rounded-2xl shadow-2xl w-full max-w-md lg:max-w-lg">
             <h1 className="text-2xl lg:text-3xl text-amber-50 font-semibold">Criar Conta</h1>
               ...
               <span className="text-xs text-amber-50">ou use seu email para cadastro</span>

             <div className="flex flex-col text-left gap-1 w-full">
               <label className="text-xs text-amber-50">Nome:</label>
               <TextField type="name" name="name" id="name" value={name} onChange={event => setName(event.target.value)} className=" bg-brand-white hover:bg-gray-100 text-brand-blue-dark"/>
